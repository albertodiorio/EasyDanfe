...
[AlturaFixa]
internal class DuplicataElement(EstiloElement estilo, DuplicataViewModel viewModel) : ElementBase(estilo)
{
    ...
    public DuplicataViewModel ViewModel { get; private set; } = viewModel;
