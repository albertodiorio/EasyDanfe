...
/// </summary>
internal class CampoElement : ElementBase
{
    ...
    public CampoElement(string cabecalho, string conteudo, EstiloElement estilo, AlinhamentoHorizontal alinhamentoHorizontalConteudo = AlinhamentoHorizontal.Esquerda) : base(estilo)
    {
        Cabecalho = cabecalho;
        Conteudo = conteudo;
        AlinhamentoHorizontalConteudo = alinhamentoHorizontalConteudo;
        IsConteudoNegrito = true;
        Height = Constants.Constants.CampoAltura;
    }
